...
export const HomePage = () => {
    ...
    return (
        <MainTemplate>
            <div className="bg-[#101015] w-full p-6 flex gap-3 h-screen">
                <div className="flex-col flex gap-3 h-full ">
                    <div className="bg-lightBlue w-72 h-[25%] px-4 py-6 flex-col flex justify-between">
                    ...
                    <div className="bg-darkBlue gap-1 w-72 h-[25%] px-4 py-6 flex-col flex justify-between">
                    ...
                    <div className="bg-darkBlue gap-1 w-72 h-[50%] px-4 py-6 flex-col flex">
